<template>
  <v-tooltip :bottom="bottom" content-class="rounded-xl py-3 tooltip"  :left="left" :right="right" :top="top" allow-overflow z-index="10" max-width="400px">
...
#app .v-tooltip__content{
    ...
    background-color: rgba(1, 72, 120, 0.96);
}
