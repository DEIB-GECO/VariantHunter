    ...
    <template v-slot:use-cases>
      ...
      <use-case source-name='Nextstrain' source-date='19/04/2022'
        ...
        <div class='with-borders white'>
          <pic :src='uc1.img1' img-max-height='300'/>
          <collage :src1='uc1.img2' :src2='uc1.img3' img-max-height='300'/>
          <pic :src='uc1.img4' img-max-height='300'/>
        </div>
      ...
      <use-case source-name='Nextstrain' source-date='19/04/2022'
        ...
        <div class='with-borders white'>
          <pic :src='uc2.img1' img-max-height='300'/>
          <collage :src1='uc2.img2' :src2='uc2.img3' img-max-height='300'/>
          <pic :src='uc2.img4' img-max-height='300'/>
        </div>
      ...
      <use-case source-name='Gisaid' source-date='06/02/2022'
        ...
        <div class='with-borders white'>
          <pic :src='uc3.img1' img-max-height='300'/>
          <collage :src1='uc3.img2' :src2='uc3.img3' img-max-height='300'/>
          <pic :src='uc3.img4' img-max-height='300'/>
        </div>
...
export default {
  name: 'LinDepGuide',
  components: {Collage, Pic, Paragraph, UseCase, FunctionGuide},
